...
class DockingDataset(Dataset):
    ...
    def __init__(self,root_path):
        self.root = root_path
        self.data = pd.read_csv(os.path.join(self.root,"/home/bayeslabs/Desktop/yashi/refined-set/out_new_edit.csv"))
    ...
    def get_voxel(self,path):
        ...
        x1 = torch.load(os.path.join(complex, path+'_ligand.pt'))
        x2 = torch.load(os.path.join(complex, path+'_protein.pt'))
        print('checkinggggpath:::::', complex)
        # print('check   path:::::', os.path.join(complex, path + '_protein.pt'))
        # print('checkinggggpath:::::', x1)
        # print('check   path:::::', x2)
